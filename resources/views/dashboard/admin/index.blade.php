...
@section('content')
    <p>Selamat datang <b>{{ auth()->user()->name }}</b> di halaman Admin Dashboard.</p>
 ...
 {{-- <!-- Website Traffic -->
    ...
    <div class="card">
    <div class="card-body pb-0">
        <h5 class="card-title">Keluhan per Kategori</h5>

        <div id="keluhanChart" style="min-height: 400px;" class="echart"></div>

        <script>
            document.addEventListener("DOMContentLoaded", () => {
                const keluhanData = @json($keluhanChartData);
                ...
                echarts.init(document.querySelector("#keluhanChart")).setOption({
                    ...
                    series: [{
                        ...
                        data: keluhanData,
                        color: [
                            '#3498db', // hardware - biru
                            '#2ecc71', // software - hijau
                            '#f1c40f'  // pengadaan aset - kuning
                        ]
                    }]
                });
            });
   ...
   <!--sejajar chart--
    <div class="row">
    <!-- Chart 1: Permintaan Barang Traffic -->
