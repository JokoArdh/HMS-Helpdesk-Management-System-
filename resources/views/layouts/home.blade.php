  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
            ...
            <!-- untuk modal alert otomatis -->
            @if($errors->any())
            <script>
            document.addEventListener('DOMContentLoaded', function () {
                // ambil semua modal yang punya class auto-open-on-error
                var modals = document.querySelectorAll('.auto-open-on-error');
...
document.getElementById('filter').addEventListener('change', function () {
    const minggu = document.getElementById('filter-minggu');
